class PokemonModelV2 {
  late List<Abilities> abilities;
  late int baseExperience;
  late List<GameIndices> gameIndices;
  late int height;
  late List<void> heldItems;
  late int id;
  late bool isDefault;
  ...
  PokemonModelV2.fromJson(Map<String, dynamic> json) {
...
class GameIndices {
  ...
  GameIndices({gameIndex, this.version});
